    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <a href="<?= site_url() ?>dashboard.php" class="btn btn-success mb-3">Go to Dashboard</a></br>
                <a href="<?= site_url() ?>apply_leave.php" class="btn btn-primary mb-3">Add New Leave</a>
